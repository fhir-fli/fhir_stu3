...
import 'package:fhir_stu3/src/fhir_db/stu3.dart';
...
Future<void> main() async {
  ...
  group('', () {
    test('Saved A Patient, Found A Patient', () async {
      final List<Resource> search1 = await fhirDb.find(
          resourceType: Stu3ResourceType.Patient, id: '1', pw: password1);
  ...
  group('Finding Things:', () {
    test('Find 1st Patient', () async {
      final List<Resource> search =
          await fhirDb.find(resourceType: Stu3ResourceType.Patient, id: id);
      const HumanName humanName =
          HumanName(family: 'Atreides', given: <String>['Duke']);
    ...
    test('Find 3rd Observation', () async {
      final List<Resource> search = await fhirDb.find(
          resourceType: Stu3ResourceType.Observation, id: 'obs3');
    ...
    test('Find All Observations', () async {
      final List<Resource> search = await fhirDb.getActiveResourcesOfType(
        resourceTypes: <Stu3ResourceType>[Stu3ResourceType.Observation],
      );
    ...
    test('Find All (non-historical) Resources', () async {
      ...
      patList.retainWhere((Resource resource) =>
          resource.resourceType == Stu3ResourceType.Patient);
      orgList.retainWhere((Resource resource) =>
          resource.resourceType == Stu3ResourceType.Organization);
      obsList.retainWhere((Resource resource) =>
          resource.resourceType == Stu3ResourceType.Observation);
  ...
  group('Deleting Things:', () {
    test('Delete 2nd Observation', () async {
      await fhirDb.delete(
        resourceType: Stu3ResourceType.Observation,
        id: 'obs2',
      );
    ...
    test('Delete All Observations', () async {
      await fhirDb.deleteSingleType(resourceType: Stu3ResourceType.Observation);
  ...
  group('Password - Finding Things:', () {
    test('Find 1st Patient', () async {
      final List<Resource> search = await fhirDb.find(
          resourceType: Stu3ResourceType.Patient, id: id, pw: password2);
      const HumanName humanName =
          HumanName(family: 'Atreides', given: <String>['Duke']);
  ...
  group('Password - Deleting Things:', () {
    test('Delete 2nd Observation', () async {
      await fhirDb.delete(
          resourceType: Stu3ResourceType.Observation, id: 'obs2');
  ...
  group('More Complicated Searching', () {
    test('(& Resources)', () async {
      ...
      final StreamSubscription<Resource?> subscription =
          fhirDb.listen(resourceType: Stu3ResourceType.Observation).listen(
        (Resource? resource) {
